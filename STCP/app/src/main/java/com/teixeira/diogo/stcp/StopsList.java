...
public class StopsList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView stops = (TextView) findViewById(R.id.stopsList);
        for (int i = 0; i < IdStops.size(); i++) {
            stops.append(IdStops.get(i));
            stops.append("\n");
        }
    ...
    public void getStops(View view) {
                ...
                stops = (TextView) findViewById(R.id.stopsList);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://api.ost.pt/stops/?name=metro&agency=22&withroutes=true",
                        new Response.Listener<String>() {
                            @Override
                            public void onResponse(String response) {
                                stops.setText("Response is: " + response);
                            }
